...
#ifndef __integer_GRAPHALG_H__
#define __integer_GRAPHALG_H__
 ...
 */
typedef struct {
  int source; /**< sommet source de l'arête */
  int destination; /**< sommet destination de l'arête */
 ...
 * contiennent des valeurs de type <b>int</b>
 *
 ...
 * un graphe (liste d'adjacence) integer_graph_t
 *
 ...
 * dont les noeuds contiennent des valeurs de type <b>int</b>
 *
 ...
 * ok)
 */
int integer_maxflow(integer_graph_t *graph, int source, int target,
