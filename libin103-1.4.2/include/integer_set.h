/*! \file integer_set.h
 * \brief Ensemble contenant des valeurs de type <b> int </b>
 *
 */
...
/*! \brief Ajouter un élément de type <b>int</b> dans l'ensemble
 *
 ...
 *
 * @param set est un pointeur vers la structure de données integer_set_t
...
/*! \brief Supprimer un élément de type <b>int</b> dans l'ensemble
 *
 * Etant donné un pointeur vers un ensemble (représenté par une liste
 * chaînée) et un pointeur vers une valeur de type <b>int</b>,
 * supprime l'élément de l'ensemble.
 *
 * @param set est un pointeur vers la structure de données integer_set_t
 * @pram data est pointeur vers une variable de type <b>int</b> qui représente la valeur à supprimer
 * @return un entier indiquant si tout s'est bien passé (0 pour OK, et -1 en cas de problème mémoire)
 */
 ...
 * deux ensembles
 *
 * @param setu l'ensemble résultat de l'union de type integer_set_t
 * @param set1 premier argument de l'opération d'union de type integer_set_t
 * @param set2 second argument de l'opération d'union de type integer_set_t
 * @return un entier indiquant si tout s'est bien passé (0 pour OK, et -1 en cas de problème)
 */
int integer_set_union(integer_set_t *setu, const integer_set_t *set1,
 ...
 * deux ensembles
 *
 * @param seti l'ensemble résultat de l'intersection de type integer_set_t
 * @param set1 premier argument de l'opération d'union de type integer_set_t
 * @param set2 second argument de l'opération d'union de type integer_set_t
 * @return un entier indiquant si tout s'est bien passé (0 pour OK, et -1 en cas de problème)
 */
 ...
 *
 * @param setd l'ensemble résultat de la différence de type integer_set_t
 * @param set1 premier argument de l'opération d'union de type integer_set_t
 * @param set2 second argument de l'opération d'union de type integer_set_t
 * @return un entier indiquant si tout s'est bien passé (0 pour OK, et -1 en cas de problème)
 */
 ...
 *
 * @param set ensemble de type integer_set_t
 * @param data valeur de type <b>int</b> que l'on souhaite tester la présence dans set
 ...
 * second.
 *
 * @param set1 ensemble de type integer_set_t
 * @param set2 ensemble de type integer_set_t
